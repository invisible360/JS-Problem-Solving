...
/* 
const degree = radianToDegree(10); // provide true/false/any string as input to check validation.
console.log(degree);
 */
 ...
 */
/* 
const isThatJsFile = isJavaScriptFile('image.js.js.js');
...
/* 
const totalPrice = oilPrice(20,22,22);
...
/* 
const totalPublicBusFare = publicBusFare(112);
